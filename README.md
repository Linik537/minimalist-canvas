...
O formulário de veículo guarda automaticamente os campos do rascunho no armazenamento local do navegador e as fotos ainda não enviadas no IndexedDB, separados por conta admin e veículo. Ao voltar à aba ou recarregar a página, o rascunho é restaurado. Ele é removido após salvar o veículo com sucesso. O editor de fotos oferece prévias 4:3 e 7:5, zoom, posicionamento, otimização em WebP, seleção da capa e reordenação por arrasto ou setas. Salve o veículo para gravar a ordem e enviar as fotos novas; a exclusão ou edição de fotos já publicadas é aplicada imediatamente.
